...
loaded_model = tf.keras.models.load_model(r"C:\Users\laxmi\OneDrive\Desktop\medical_img_cap\Medical-Report-Generator\server\accumodelpp84.h5")
...
model = load_model(r'C:\Users\laxmi\OneDrive\Desktop\medical_img_cap\Medical-Report-Generator\server\indianamodel.keras')


# Load necessary pre-processing objects (wordtoix, ixtoword, max_length)
with open(r'C:\Users\laxmi\OneDrive\Desktop\medical_img_cap\Medical-Report-Generator\server\wordtoix.json', 'r') as f:
    ixtoword = json.load(f)

with open(r'C:\Users\laxmi\OneDrive\Desktop\medical_img_cap\Medical-Report-Generator\server\wordtoix1.json', 'r') as f:
